        ...
        <footer className='bg-[#2d0097]'>
            <div className="footer justify-between container mx-auto sm:footer-horizontal px-5 py-10 text-white">
                <aside >
                    ...
                    <p>
                        Hero.io An Android app store with a simple yet efficient page experience.
                        <br />
                        Discover the app you want easier, faster, and safer.
                    </p>
                </aside>
                <nav>
                ...
                <nav>
                    ...
                    <a className="link link-hover">Game Store</a>
                    <a className="link link-hover">Mini Game</a>
                    <a className="link link-hover">TVOnic</a>
                </nav>
                <nav>
                    <h6 className="footer-title">COMPANY</h6>
                    <a className="link link-hover">About Us</a>
                    <a className="link link-hover">Developer Sonsole</a>
            ...
            <div className='bg-[#001931]'>
                <div className="container mx-auto footer sm:footer-horizontal text-neutral-content items-center p-4">
                    <aside className="grid-flow-col items-center">
                        <p>Copyright © 2014-2025 Hero.io All rights reserved</p>
                    </aside>
